...
def policy_iteration(env):
    ...
    value_function = np.zeros(env.observation_space.n) # 500 0's
    
    total_value_iterations = 0 

    for i in range(num_iterations):
        
        value_function, num_value_iteration = compute_value_function(policy, value_function) # added 2 parameters
...
def compute_value_function(policy, value_table, env=env): # included "value_table" parameter
